...
export default function FackImage_Exam() {
  ...
  const questions: Question[] = [
    { text: 'Is This AI Generated (DeepFack)?', image: './image/4.jpg', options: [{ text: 'Yes', id: 'false' }, { text: 'No', id: 'true' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/23.jpg', options: [{ text: 'Yes', id: 'true' }, { text: 'No', id: 'false' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/21.jpg', options: [{ text: 'Yes', id: 'true' }, { text: 'No', id: 'false' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/ai11.jpg', options: [{ text: 'Yes', id: 'true' }, { text: 'No', id: 'false' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/ai16.jpg', options: [{ text: 'Yes', id: 'false' }, { text: 'No', id: 'true' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/ai14.jpg', options: [{ text: 'Yes', id: 'true' }, { text: 'No', id: 'false' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/19.jpg', options: [{ text: 'Yes', id: 'true' }, { text: 'No', id: 'false' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/20.jpg', options: [{ text: 'Yes', id: 'false' }, { text: 'No', id: 'true' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/ai18.jpg', options: [{ text: 'Yes', id: 'true' }, { text: 'No', id: 'false' }] },
    { text: 'Is This AI Generated (DeepFack)?', image: './image/ai4.jpg', options: [{ text: 'Yes', id: 'true' }, { text: 'No', id: 'false' }] },
  ];
  ...
  const submitQuiz = () => {
    ...
    localStorage.setItem('MidImageExamMarks', JSON.stringify({ score}))
  };
    ...
    <div className="px-4 py-6 md:px-12 md:py-8 lg:px-24 lg:py-10">
      ...
      <div className="flex justify-between items-center mb-6 flex-wrap gap-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <NavLink to='/MidImageExam' className="px-3 py-1 rounded-xl border-2 border-white bg-yellow-400 text-white">Mid</NavLink>
